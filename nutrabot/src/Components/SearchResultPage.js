...
export default function SearchResult({ searchedProducts, searchedRecipes, addtoMymeals }) {
  return (
    <div>
<section>
  <table>
...
<tbody>
  {searchedRecipes.map((recipe) => {
    return (<Recipe key={uuid()} name={recipe.recipe.label} recipeCalories={recipe.recipe.calories} image={recipe.recipe.image} url={recipe.recipe.url} />)
  })}
</tbody>
  </table>
</section>
